...
<section class="content-header">
    ...
    <div class="content-header-right">
        <a href="area-add.php" class="btn btn-primary btn-sm">Add Areas</a>
    </div>
</section>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="area-edit.php?id=<?php echo $row['area_id']; ?>" class="btn btn-primary btn-xs">Edit</a>
                                        <a href="#" class="btn btn-danger btn-xs" data-href="area-delete.php?id=<?php echo $row['area_id']; ?>" data-toggle="modal" data-target="#confirm-delete">Delete</a>
                                    </td>
                                </tr>
                            <?php
                            }
