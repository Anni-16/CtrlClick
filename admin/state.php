...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="state-add.php" class="btn btn-primary btn-sm">Add States</a>
	</div>
</section>
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td><?php echo $row['state_capital']; ?></td>
									<td>
										<?php
										if ($row['state_font_display'] == 1) {
									...
									<td>
										<a href="state-edit.php?id=<?php echo $row['state_id']; ?>" class="btn btn-primary btn-xs">Edit</a>
										<a href="#" class="btn btn-danger btn-xs" data-href="state-delete.php?id=<?php echo $row['state_id']; ?>" data-toggle="modal" data-target="#confirm-delete">Delete</a>
									</td>
								</tr>
							<?php
							}
