...
<section class="content-header">
	<div class="content-header-left">
		<h1>View Client Logo</h1>
	</div>
	<div class="content-header-right">
		<a href="client-logo-add.php" class="btn btn-primary btn-sm">Add Client Logo</a>
	</div>
</section>
            ...
            <tbody>
            	...
            	foreach ($result as $row) {
					...
					<tr>
	                    ...
	                    <td><img src="./uploads/client-logo/<?php echo $row['client_image']; ?>" alt="<?php echo $row['client_name'];?>" style="width: 100px;"></td>
                        <td>
	                    ...
	                    <td>
	                        <a href="client-logo-edit.php?id=<?php echo $row['client_id']; ?>" class="btn btn-primary btn-xs">Edit</a>
	                        <a href="#" class="btn btn-danger btn-xs" data-href="client-logo-delete.php?id=<?php echo $row['client_id']; ?>" data-toggle="modal" data-target="#confirm-delete">Delete</a>
	                    </td>
	                </tr>
            		<?php
            	}
